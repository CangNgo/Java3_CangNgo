...
public class bai3_frame extends javax.swing.JFrame {
        ...
        public boolean CheckNull() {
                ...
                if (txtContact.getText().equals(""))
                        return false;
                if (txtQuality.getText().equals(""))
                        return false;
                if (txtErroll.getText().equals(""))
                        return false;
        ...
        public void Save() {
                ...
                thongtin frame = new thongtin(txtFrist.getText(), txtLast.getText(), txtContact.getText(),
                                txtQuality.getText(),
                                txtErroll.getText(), txtSpeci.getText(), txtSport.getText(), txtHobbies.getText(),
                                txtAddress.getText());
                ...
                list.forEach((tt) -> {
                        ...
                        JOptionPane.showMessageDialog(this,
                                        "tên: " + tt.getFname() + "\nHọ: " + tt.getLname() + "\nContact: "
                                                        + tt.getContact() + "\nhighest: "
                                                        + tt.getHighest() + "\nSpecifacation: " + tt.getSpec()
                                                        + "\nErroll for: " + tt.getErrol()
                                                        + "\nHobbies: " + tt.getHobbies() + "\nSport: "
                                                        + tt.getSoprt());
                });
        }
        ...
        private void txtFristActionPerformed(java.awt.event.ActionEvent evt) {
                // TODO add your handling code here:
        }

        private void txtSportActionPerformed(java.awt.event.ActionEvent evt) {
                // TODO add your handling code here:
        }
        ...
        public static void main(String args[]) {
                ...
                try {
                        ...
                        java.util.logging.Logger.getLogger(bai3_frame.class.getName()).log(
